...
export const musashiStages = {
  ...
  loadElectrons3: {
    name: "Load e− 3",
    voltages: [-80, -30, 0, 0, 30, 0, 0, 0, -30, -80],
    description: "Raise barriers around the electron plasma.",
  },
  loadElectrons4: {
    name: "Load e− 4",
    voltages: [-120, -120, -20, -20, 50, -20, -20, -20, -120, -120],
    description: "Electrons are trapped in MUSASHI.",
  },

  kickElectrons1: {
    name: "Kick e− 1",
    voltages: [-120, -120, -20, -20 , -20, -20, -20, -20, -120, -120],
    description: "Prepare to eject electrons.",
  },
  kickElectrons2: {
    name: "Kick e− 2",
    voltages: [-120, -40, -20, -20, -20, -20, -20, -20, -20, -20],
  ...
  trapAntiprotons1: {
    name: "Trap p̄ 1",
    voltages: [-40, -40, -40, -40, 80, -40, -40, -40, -40, -120],
    description: "Open entrance for antiprotons.",
  },
  trapAntiprotons2: {
    name: "Trap p̄ 2",
    voltages: [-40, -40, -40, -40, 80, -40, -40, -40, -120, -120],
    description: "Antiprotons enter MUSASHI.",
  },
  trapAntiprotons3: {
    name: "Trap p̄ 3",
    voltages: [-40, -40, -40, -40, 20, -40, -40, -40, -100, -120],
    description: "Raise upstream barrier.",
  },
  trapAntiprotons4: {
    name: "Trap p̄ 4",
    voltages: [-120, -40, -20, -20, 20, -20, -20, -40, -120, -120],
